...
const enMessages = {
  ...
  settingsDesc: "Configure model credentials and market data source tokens for your signed-in account.",
  llmSettings: "LLM Settings",
  llmSettingsDesc: "Choose the model used by the agent. Saved values are stored in MongoDB per user.",
  ...
  dataSourceSettingsDesc: "Configure optional market data credentials used by your backtests and research agents.",
  ...
  authRequiredDesc: "Please sign in with DreamAuth again to access protected settings.",
...
const zhMessages: Messages = {
  ...
  settingsDesc: "配置当前登录用户的模型凭据和行情数据源令牌。",
  llmSettings: "大模型设置",
  llmSettingsDesc: "选择智能体使用的模型。保存后的值会按用户写入 MongoDB。",
  llmConnection: "连接",
  llmGeneration: "生成参数",
  llmProvider: "服务商",
  llmModelName: "模型",
  ...
  dataSourceSettingsDesc: "配置当前用户的回测和研究智能体使用的可选行情数据凭据。",
  ...
  authRequired: "需要登录",
  authRequiredDesc: "请重新使用 DreamAuth 扫码登录，以访问受保护的设置。",
  unknownError: "未知错误",
